...
export class UI {
  //calling the elements we will send HTML into todo
  constructor() {
  ...
  //print profile interface on screen
  renderProfile(data) {
  ...
  //printing projects on screen
  renderProjects(data) {
    // clear repo space
    this.repoArea.innerHTML = ''
    // create a card for each element in the projects array and print it on the screen
    data.forEach((repo) => {
      console.log(repo)
      this.repoArea.innerHTML += `
  ...
  // delete the warning from the screen
  clearAlert() {
